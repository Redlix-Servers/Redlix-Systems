            ...
            <main className="flex-grow flex items-center justify-center px-4 sm:px-8 py-12">
                <div className="w-full max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <header className="mb-10 text-center">
                        <h1 className="text-3xl font-normal tracking-tight text-zinc-900 mb-2">
                            Create <span className="text-red-600">Account</span>
                        </h1>
                        <p className="text-zinc-500 text-xs font-normal">
                            Sign up to start building your projects.
                        </p>
                    </header>
                        ...
                        <form onSubmit={handleSignup} className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold tracking-wider text-red-600 uppercase px-1">Email Address</label>
                                    <AuthInput
                                        type="email"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold tracking-wider text-red-600 uppercase px-1">Choose Password</label>
                                    <AuthInput
                                        type="password"
                                        placeholder="••••••••"
                                        value={password}
                            ...
                            <div className="pt-4">
                             ...
                             <div className="relative py-6">
                                ...
                                <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                                    <span className="bg-white px-3 text-zinc-400 font-bold">Sync with</span>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 bg-white border border-zinc-400 h-12 rounded-none hover:bg-zinc-50 transition-all group"
                            >
                                ...
                                <span className="text-[11px] font-semibold tracking-wide text-zinc-900">Continue with Google</span>
                            </button>

                            <p className="text-[10px] text-zinc-400 mt-6 font-bold uppercase tracking-[0.2em] text-center leading-relaxed">
                                Already have an account?{" "}
                                <a href="/developer/login" className="text-red-600 hover:text-red-700 underline decoration-red-200">Login here</a>
                            </p>
                        </form>
                    </div>
